...
- Make sure to add micro-interactions, ui-effects and fluid transition animations(symmetrical) to be present by default in all the necessary UI components. Leverage from libraries like framer motion, GSAP or react-spring etc.

...
import type { GraphData, GraphEdge, GraphNode } from "@/lib/graph/graph-data";
import { recomputeIncidence } from "@/lib/graph/graph-data";
import type { RimSlot } from "@/lib/graph/draw-arrow";
...
} from "@/lib/graph/bake-worker-pool";
import {
  GraphSpatialIndex,
  type WorldAabb,
...
import { expandDirtyEdgesForHubs } from "@/lib/graph/graph-diff";
import {
  GRAPH_BG,
  GRAPH_EDGE_PART_OF,
